...
class PostDetailsComponent extends PureComponent {
  ...
  render() {
    ...
    console.log("Test PostDetailsComponent");
            ...
            >
              <div className="appContainer">
                <div className="mainPageHeading">
                  ...
                  <h1>Ogłoszenie {this.props.match.params.id}</h1>
                </div>
                <div className="postHeading">
                  <div />
                  <div className="postHeading__heading">{this.props.match.params.heading}</div>
...
const mapStateToProps = (state, ownProps) => {
  console.log(state);
  console.log("PostDetailsComponent");
